...
export const fallback = <div className='loader-container'>
  ...
  return (
    ...
    >
      <Routes>
        ...
        <Route path="/home" element={<Suspense fallback={fallback} ><Home /></Suspense>} />
        <Route path="/users">
          <Route index element={<Suspense fallback={fallback} ><Users /></Suspense>} />
          <Route path=":page/:id" element={<Suspense fallback={fallback} ><UserDetails /></Suspense>} />
        </Route>
        <Route path="/errorBoundary" element={<Suspense fallback={fallback} ><ErrorTester /></Suspense>} />
        <Route path="/sign-in" element={<Suspense fallback={fallback} ><Auth /></Suspense>} />
